...
Follow the same steps as the plugin root `SETUP.md`. Guide the signed-in
admin. Do not invent a Consumer Key, server URL, or workaround. Do not
document Claude Code `--callback-port`.
